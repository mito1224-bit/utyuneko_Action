    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                half4 colorR = tex2D(_MainTex, uvR) + _TextureSampleAdd;
                half4 colorG = tex2D(_MainTex, uvG) + _TextureSampleAdd;
                half4 colorB = tex2D(_MainTex, uvB) + _TextureSampleAdd;
